...
class HiCircleIndicator @JvmOverloads constructor(
     ...
     */
    @DrawableRes
    private val mPointSelected = R.drawable.shape_point_selected
    ...
    override fun onInflate(count: Int) {
        ...
        val rootParams = LayoutParams(VWC, VWC);
        rootParams.gravity = Gravity.BOTTOM or Gravity.CENTER;
        addView(groupView, rootParams)
    }
